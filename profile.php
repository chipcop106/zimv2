            ...
            <div class="media-body mg-t-30 mg-lg-t-0 pd-lg-x-10">
                <div class="search-post mg-b-10 d-flex align-items-center bd">
                    <div class="share-status bd-r-1">
                        <i data-feather="edit-3"></i> <a href="javascript:;" class="link-03 mg-sm-l-10 write-status">
                            <span class="d-none d-sm-inline">Write status</span> </a>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body pd-15">
                            <div class="status-wrap">
                                <textarea name="" id="" cols="" rows="" placeholder="Write something new..."
                                    class="form-control bd-0 outline-none shadow-none"></textarea>
                                <div class="image-demo"><img src="" alt=""></div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex align-content-center justify-content-between">
                                <div class="d-flex align-items-center action-icons">
                                    ...
                                    <a href="javascript:;" class="d-inline-block pd-5 select-background"
                                        ...
                                        Background</a>
                                    <input type="file" class="img-upload d-none" accept="image/*">
                                </div>
                            ...
                            <div class="media-header d-flex align-items-center justify-content-between">
                                ...
                                <div class="action-blog ">
                                  ...
                                  <ul class="action-lists dropdown-menu ">
                                    <li class="action-link dropdown-item"><a href="javascript:;" class="act-link delete-post">Xoá bài viết</a></li>
                                  </ul>
                                </div>
                            </div>
                            <div class="media-body"
                                style="background-image:url('assets/img/bg-status4.jpg');">
...
$(document).ready(function() {
    ...
    $('body').on('click', '.comment-toggle', function() {
        $(this).closest('.comment-wrap').find('.comment-block').slideToggle();
    });
});
</script>